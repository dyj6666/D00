...
- 控制口（默认 COM5 @115200，自动探测 CH340）：板子 USART2 调试口，
  用于 `la_dma_start/stop/buf/trig`
- 数据口（默认 COM13 @921600，自动探测 CH9102/CH343）：板子 USART1
  上位机口，用于二进制采样下载

> 换 USB 口后 COM 号会漂移，上位机会自动选择优先端口，无需手动改。
