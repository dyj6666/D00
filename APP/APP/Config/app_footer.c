 ...
 *
 * 架构位置：APP 配置层；链接到 RUN 分区最后 8 字节（0x080DFFF8，方案B）
 * 背景：BOOT 以 0x080DFFF8 == 0x4F54412E 判定 RUN 有效。OTA 升级时由
...
#define APP_FOOTER_VERSION  213u          /* 与 config/version.json ota_version 同步 */
